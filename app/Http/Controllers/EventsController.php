...
class EventsController extends BaseController
{
    ...
    public function getEventsWithWorkshops() {
		$evenistnce = new Event();
		$workshopinstance = new Workshop();
		$allevents = $evenistnce->join($workshopinstance->gettblename(), $workshopinstance->gettblename().'.event_id', '=', $evenistnce->gettblename().'.id')->whereRaw('1')->groupby($evenistnce->gettblename().'.id')->get();
		return $allevents;
    }
    ...
    public function getFutureEventsWithWorkshops() {
		$evenistnce = new Event();
		$workshopinstance = new Workshop();
		$allevents = $evenistnce->join($workshopinstance->gettblename(), $workshopinstance->gettblename().'.event_id', '=', $evenistnce->gettblename().'.id')->whereRaw($workshopinstance->gettblename().'.start >'.strtotime(date('Y-m-d')))->groupby($evenistnce->gettblename().'.id')->get();
		return $allevents;
    }
}
